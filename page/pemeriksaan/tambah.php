...
<tr><td>
	<div class="form-group">
        ...
        <?php
		$sql1=mysqli_query($conn,"select * from pekerjaan ");
...
<tr><td>		
	...
	<div class="form-group">
        ...
        <?php
		$sql2=mysqli_query($conn,"select * from jenis_pasien ");
...
//include ('libs/koneksi.php');
		  ...
		  $s=mysqli_query($conn,"select kode,nama from kelompok_parameter_uji");
		  $count_a=mysqli_num_rows($s);
		  //for ($i=1;$i <=$count_a;$i++) {
		  //echo "div".$i; }
		  $i=1;
...
$o=$o+1;
  ...
  echo"</div>";
	...
	<br>
      <div style="padding:3px;overflow:auto;width:auto;height:250px;border:0px solid grey">
		 <?php 
			$mysql_paket=mysqli_query($conn,"SELECT a.kode,a.nama_paket,a.parameter,b.total FROM paket_pemeriksaan a LEFT JOIN paket_total b ON(a.kode)=b.kode");
			$i=1;
			while($data_paket=mysqli_fetch_array($mysql_paket)) {
