<?php 
	...
	$sql=$koneksi->query("update tb_rekam_medis set statuspembayaran='Selesai' where no_rm='$norm'");
	if ($sql){
        ?>
        <script type="text/javascript">
        alert ("Nota Siap DiCetak");
...
<table border="0">
	...
	<tbody>
		...
		<?php
	        $no=1;
	        $sql3= $koneksi->query("Select tb_rekam_medis_detail2.no_rm,tb_obat.nm_obat,jumlah,harga_jual,harga_jual*jumlah AS total ,tb_rekam_medis.biayaperiksa
from tb_rekam_medis_detail2,tb_obat,tb_rekam_medis
where tb_rekam_medis_detail2.no_rm=tb_rekam_medis.no_rm and
     tb_obat.kd_obat=tb_rekam_medis_detail2.kd_obat and tb_rekam_medis_detail2.no_rm='$norm'");
	        ...
	        <?php }
        $sql4 = $koneksi->query("Select tb_rekam_medis_detail2.no_rm,tb_obat.nm_obat,jumlah,harga_jual,harga_jual*jumlah AS total ,tb_rekam_medis.biayaperiksa
                from tb_rekam_medis_detail2,tb_obat,tb_rekam_medis
                where tb_rekam_medis_detail2.no_rm=tb_rekam_medis.no_rm and
                     tb_obat.kd_obat=tb_rekam_medis_detail2.kd_obat and tb_rekam_medis_detail2.no_rm='$norm'");
            ...
            ?>    
            <tr>
                <td colspan="4" >Biaya Periksa</td>
                <td align="center"><?php echo $data2['biayaperiksa']?></td>
            </tr>
            <tr>
